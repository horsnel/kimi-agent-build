...
export default function SectorRotation() {
  ...
  return (
    <div ref={sectionRef}>
      ...
      {/* Premium Gate */}
      <section className="sr-section max-w-7xl mx-auto px-6 py-12">
        <PremiumGate featureName="Sector Rotation Tracker" description="Get real-time sector rotation signals with institutional-grade money flow data." />
      </section>
    </div>
  );
}
